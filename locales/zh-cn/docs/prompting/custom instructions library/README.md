...
Cline的自定义指令是一组您定义的指导方针或规则，用于调整AI的行为和输出，以适应特定的任务或项目。可以将它们视为Cline的专用“编程”，使您能够：

-   **强制执行编码实践：**确保一致的代码风格，遵循设计模式，并针对特定语言或框架的最佳实践。
-   **标准化文件结构：**规定文件命名约定、文件夹组织和项目结构。
-   **指导测试程序：**定义生成单元测试、集成测试和确保足够代码覆盖率的规则。
-   **自动化重复任务：**创建指令来处理常见或繁琐的开发工作流程，提高效率。
-   **提高代码质量：**为代码的可读性、可维护性和性能优化设定标准。
